...
namespace StayBeautifulSMS
{
    public partial class PurchaseBill : System.Web.UI.Page
    {
        ...
        protected void SetData()
        {
            ...
            cmdInfo.CommandText = @"SELECT pr.Customer_ID, cs.Customer_Name, pr.Purchased_Date, us.user_username from Purchase pr inner join [App Dev CW2].[dbo].[User] us on us.user_id = pr.user_id inner join Customer cs on cs.Customer_id = pr.customer_id where pr.purchase_id = " + id;
