<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="SearchItem.aspx.cs" Inherits="StayBeautifulSMS.SearchItem" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="basicForm-wrapper">
    <div>
        <div>
            <h2><asp:Label ID="Label4" class="headings" runat="server" Text="Search Item"></asp:Label> </h2>
        </div> <br />
