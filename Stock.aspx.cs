...
namespace StayBeautifulSMS
{
    public partial class Stock : System.Web.UI.Page
    {
        ...
        protected void stockGridView_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string updated_quantity = (row.Cells[2].Controls[0] as TextBox).Text;
            string date = (row.Cells[3].Controls[0] as TextBox).Text;
            string mfd = (row.Cells[4].Controls[0] as TextBox).Text;
            string exp = (row.Cells[5].Controls[0] as TextBox).Text;
            ...
            using (OleDbConnection con = new OleDbConnection(constr))
            {
                ...
                OleDbCommand cmd1 = new OleDbCommand("Update items set available_quantity=available_quantity-" + qty + "+" + updated_quantity + ", stocked_date = CAST('" + date + "' as DATE) where item_id = " + ID);
        ...
        //        OleDbCommand cmd2 = new OleDbCommand("DELETE FROM Stock WHERE stock_id = " + ID);
        //        //cmd1.Connection = con;
        //        cmd2.Connection = con;
        //        con.Open();
        //        //cmd1.ExecuteNonQuery();
        ...
        //protected void stockGridView_RowCancelingEdit1(object sender, GridViewCancelEditEventArgs e)
        //{
